...
namespace MinimalChatApplication.Migrations
{
    ...
    [Migration("20231009065509_channel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinimalChatApplication.Models.ChannelMember", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ChannelMember", (string)null);
                });

            modelBuilder.Entity("MinimalChatApplication.Models.Channels", b =>
                {
                    b.Property<int>("ChannelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinimalChatApplication.Models.ChannelMember", b =>
                {
                    b.HasOne("MinimalChatApplication.Models.Channels", "Channel")
            ...
            modelBuilder.Entity("MinimalChatApplication.Models.Message", b =>
                {
                    b.HasOne("MinimalChatApplication.Models.Channels", "Channels")
                        .WithMany("Messages")
                        .HasForeignKey("ChannelId")
